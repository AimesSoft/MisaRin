 ...
 * @returns {boolean}
 */
export function canvas_engine_apply_antialias(handle, layer_index, level) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_apply_filter(handle, layer_index, filter_type, param0, param1, param2, param3) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_apply_layer_transform(handle, layer_index, matrix, bilinear) {
 ...
 * @param {number} height
 */
export function canvas_engine_attach_present(handle, width, height) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_bucket_fill(handle, layer_index, start_x, start_y, color_argb, contiguous, sample_all_layers, tolerance, fill_gap, antialias_level, swallow_colors, selection_mask) {
 ...
 * @param {number} layer_index
 */
export function canvas_engine_clear_layer(handle, layer_index) {
 ...
 * @returns {number}
 */
export function canvas_engine_create(width, height) {
 ...
 * @param {number} handle
 */
export function canvas_engine_dispose(handle) {
 ...
 * @param {number} color_argb
 */
export function canvas_engine_fill_layer(handle, layer_index, color_argb) {
 ...
 * @returns {number}
 */
export function canvas_engine_get_input_queue_len(handle) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_get_layer_bounds(handle, layer_index, out_bounds) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_magic_wand_mask(handle, layer_index, start_x, start_y, sample_all_layers, tolerance, selection_mask, out_mask) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_poll_frame_ready(handle) {
 ...
 */
export function canvas_engine_push_points(handle, points, point_count) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_read_layer(handle, layer_index, out_pixels) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_read_layer_preview(handle, layer_index, width, height, out_pixels) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_read_present(handle, out_pixels) {
    var ptr0 = passArray8ToWasm0(out_pixels, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
 ...
 * @param {number} handle
 */
export function canvas_engine_redo(handle) {
 ...
 */
export function canvas_engine_reorder_layer(handle, from_index, to_index) {
 ...
 */
export function canvas_engine_reset_canvas(handle, background_color_argb) {
 ...
 * @param {number} background_color_argb
 */
export function canvas_engine_reset_canvas_with_layers(handle, layer_count, background_color_argb) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_resize_canvas(handle, width, height, layer_count, background_color_argb) {
 ...
 * @param {number} layer_index
 */
export function canvas_engine_set_active_layer(handle, layer_index) {
 ...
 */
export function canvas_engine_set_brush(handle, color_argb, base_radius, use_pressure, erase, antialias_level, brush_shape, random_rotation, rotation_seed, spacing, hardness, flow, scatter, rotation_jitter, snap_to_pixel, hollow, hollow_ratio, hollow_erase_occluded, streamline_strength) {
 ...
 */
export function canvas_engine_set_layer_blend_mode(handle, layer_index, blend_mode) {
 ...
 */
export function canvas_engine_set_layer_clipping_mask(handle, layer_index, clipping_mask) {
 ...
 */
export function canvas_engine_set_layer_opacity(handle, layer_index, opacity) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_set_layer_transform_preview(handle, layer_index, matrix, enabled, bilinear) {
    const ptr0 = passArrayF32ToWasm0(matrix, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 */
export function canvas_engine_set_layer_visible(handle, layer_index, visible) {
 ...
 * @param {Uint8Array} selection_mask
 */
export function canvas_engine_set_selection_mask(handle, selection_mask) {
    const ptr0 = passArray8ToWasm0(selection_mask, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 */
export function canvas_engine_set_view_flags(handle, view_flags) {
 ...
 * @param {number} handle
 */
export function canvas_engine_spray_begin(handle) {
 ...
 */
export function canvas_engine_spray_draw(handle, points, point_count, color_argb, brush_shape, erase, antialias_level, softness, accumulate) {
 ...
 * @param {number} handle
 */
export function canvas_engine_spray_end(handle) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_translate_layer(handle, layer_index, delta_x, delta_y) {
 ...
 * @param {number} handle
 */
export function canvas_engine_undo(handle) {
 ...
 * @returns {boolean}
 */
export function canvas_engine_write_layer(handle, layer_index, pixels, record_undo) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rust_lib_misa_rin_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
