...
/// Registers the pure Dart Linux implementation with the Flutter toolchain.
class FilePickerLinuxPlugin {
  /// Called by Flutter's generated registrant to wire up the platform instance.
  static void registerWith() {
    FilePicker.platform = FilePickerLinux();
  }
}

/// Registers the macOS implementation with the Flutter toolchain.
class FilePickerMacOSPlugin {
  /// Called by Flutter's generated registrant to wire up the platform instance.
  static void registerWith() {
...
/// Registers the Windows implementation with the Flutter toolchain.
class FilePickerWindowsPlugin {
  /// Called by Flutter's generated registrant to wire up the platform instance.
  static void registerWith() {
